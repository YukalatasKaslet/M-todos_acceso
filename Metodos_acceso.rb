class Course 
  ...
  # def course_name #reader course_name
  #   @course_name
  # end

  # def course_name=(new_name) #writer course
...
class Student
  ...
  # def name=(new_name) #writer name
  #   @name = new_name
  # end

  # def last_name #reader last_name
  #   @last_name
  # end

  # def last_name=(new_last_name) #writer last_name
  #   @last_name = new_last_name
  # end

  # def campus #reader campus
  #   @campus
  # end

  # def campus=(new_campus) #writer campus
  #   @campus = new_campus
  # end
